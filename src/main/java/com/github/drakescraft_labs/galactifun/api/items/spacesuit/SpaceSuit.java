package com.github.drakescraft_labs.galactifun.api.items.spacesuit;
...
public class SpaceSuit extends SlimefunItem implements ProtectiveArmor {
    ...
    private static final NamespacedKey SPACE_SUIT_KEY = Galactifun.legacyKey("space_suit");
    private static final NamespacedKey OXYGEN_KEY = Galactifun.legacyKey("oxygen");
